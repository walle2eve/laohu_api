...
class UserOrderInfoModel extends Model
{
	...
	public function deposit($operatorid,$user_info,$adminname,$operatororderid,$amount,$remark=''){
		...
		$sn_info = $this->add_order_info($operatorid,$user_info,$adminname,$operatororderid,$amount,$status,self::DEPOSIT_ORDER_TYPE,$remark);
	...
	public function withdrawal($operatorid,$user_info,$adminname,$operatororderid,$amount,$remark=''){
		...
		$sn_info = $this->add_order_info($operatorid,$user_info,$adminname,$operatororderid,$amount,$status,self::WITHDRAWAL_ORDER_TYPE,$remark);
	...
	// 增加订单信息
	private function add_order_info($operatorid,$user_info,$adminname,$operatororderid,$amount,$status,$order_type,$remark=''){
